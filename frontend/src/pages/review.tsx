  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <form onSubmit={handleSubmit} className="rounded-[32px] border border-[#F4ECE1] bg-white p-6 shadow-sm md:p-8">
        ...
        <button disabled={saving} type="submit" className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-gradient-kenya px-5 py-4 font-black text-white disabled:cursor-not-allowed disabled:opacity-70">

        ...
        <div className="relative z-10 w-full max-w-md">
          <GlassCard variant="light" className="rounded-[32px] border border-white/50 p-6 lg:border-[#F4ECE1] dark:lg:border-[#3A2B26] lg:bg-white dark:lg:bg-[#221917] lg:p-8">
            <div className="mb-6 text-center lg:text-left">
              ...
              <h1 className="text-4xl font-black text-white lg:text-[#2B1612] dark:lg:text-[#F4ECE1]">Complete your profile</h1>
              <p className="mt-2 text-white/80 lg:text-[#2B1612]/60 dark:lg:text-[#F4ECE1]/60">Tafadhali chagua nafasi yako na kaunti ili tuanze.</p>
            </div>
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div>
                <label className="mb-2 ml-1 block text-sm font-bold text-white lg:text-[#2B1612] dark:lg:text-[#F4ECE1]">Full name</label>
              ...
              <CountySelect value={county} onChange={(e) => setCounty(e.target.value)} className="bg-white dark:bg-[#1D1512]" />
              <div>
